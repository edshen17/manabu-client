    ...
    <div class="card-form">
      ...
      <div class="card-form__inner">
        <div class="card-input">
          <label for="cardNumber" class="card-input__label text-left">Card Number</label>
          <input
            type="text"
            id="cardNumber"
        ...
        <div class="card-input">
          <label for="cardName" class="card-input__label text-left">Card Holders</label>
          <input
            type="text"
            id="cardName"
            class="card-input__input"
        ...
        <div class="card-form__row">
          <div class="card-form__col">
            <div class="card-form__group">
              <label for="cardMonth" class="card-input__label text-left"
          ...
          <div class="card-form__col -cvv">
            <div class="card-input">
              <label for="cardCvv" class="card-input__label text-left">CVV</label>
              <input
                type="text"
                class="card-input__input"
                id="cardCvv"
